...
from ..models.utils import validate_and_parse_vib_state_str, canonicalise_and_parse_el_state_str
...
class TestState(TestCase):
    ...
    def test_create_delete_state(self):
        ...
        _ = State.create_from_data(self.diff_isotopologue, 0, 0, vib_state_str='0', el_state_str='1SIGMA-')
