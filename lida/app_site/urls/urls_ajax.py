...
from ..views import (
    MoleculeListAjaxView, StateListAjaxView, TransitionListAjaxView,
    TransitionToStateListAjaxView, TransitionFromStateListAjaxView
)

urlpatterns = [
    path(
        'molecule/list/all/',
        MoleculeListAjaxView.as_view(),
        name='molecule-list-ajax'
    ),
    path(
        'state/list/<str:mol_slug>',
        StateListAjaxView.as_view(),
        name='state-list-ajax'
    ),
    path(
